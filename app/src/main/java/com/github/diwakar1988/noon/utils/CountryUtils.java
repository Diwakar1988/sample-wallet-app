...
public class CountryUtils {
    ...
    private static Map<String, String> phone2country = new HashMap<String, String>();
    ...
    static {
        ...
        Set<Map.Entry<String, String>> entries = country2phone.entrySet();
        for (Map.Entry entry :
                entries) {
            phone2country.put(entry.getValue().toString(),entry.getKey().toString());
        }
    }


    public static String getCountryFullName(String iso){
        Locale loc = new Locale("",iso);
        return loc.getDisplayCountry();
    }
    public static String getCountryISOCode(String phoneCode){
        return phone2country.get(phoneCode);
    }
}